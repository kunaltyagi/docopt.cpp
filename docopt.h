...
namespace docopt {
	...
	std::map<std::string, value> DOCOPT_API constexpr docopt_parse(std::string const& doc,
	...
	std::map<std::string, value> DOCOPT_API constexpr docopt(std::string const& doc,
					    std::vector<std::string> const& argv,
					    bool help = true,
